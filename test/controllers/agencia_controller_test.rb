...
class AgenciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agencium" do
    assert_difference('Agencium.count') do
      post agencia_url, params: { agencium: { contraseÇña: @agencium.contraseÇña, mail: @agencium.mail, nombre: @agencium.nombre } }
    end
  ...
  test "should update agencium" do
    patch agencium_url(@agencium), params: { agencium: { contraseÇña: @agencium.contraseÇña, mail: @agencium.mail, nombre: @agencium.nombre } }
